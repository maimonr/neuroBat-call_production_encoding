...
stabilityBounds = get_stability_bounds(batParams,params);

[call_ts, cut_call_data, all_call_timestamps, included_call_times,...
    included_call_ks] = get_call_timestamps(cut_call_data,stabilityBounds,params);
    ...
    case 'lfp'
        ...
        switch batParams.expType
            ...
            case 'juvenile'
                ...
                exp_date_str = datestr(batParams.expDate,'yyyymmdd');
                lfp_data_fname = [batParams.baseDir 'bat' batParams.batNum filesep 'neurologger_recording' exp_date_str '\lfpformat\LFP.mat'];
...
function stabilityBounds = get_stability_bounds(batParams,params)
